...
public class ExcelTableTests
{
    ...
    public void ExcelTable_Constructor_EmptyName_ThrowsException()
    {
        ...
        var ex = Assert.Throws<ArgumentException>(() => new ExcelTable(emptyName, range));
    ...
    public void ExcelTable_Constructor_SingleCell_ThrowsException()
    {
        ...
        var ex = Assert.Throws<ArgumentException>(() => new ExcelTable("Table1", range));
    ...
    {
        var sheet = new WorkSheet("TestSheet");
        sheet.AddCell(new(0, 0), "Header1");
        sheet.AddCell(new(1, 0), "Header2");
        sheet.AddCell(new(0, 1), "Data1");
        sheet.AddCell(new(1, 1), "Data2");
    ...
    {
        var sheet = new WorkSheet("TestSheet");
        sheet.AddCell(new(0, 0), "Table1 Header");
        sheet.AddCell(new(0, 1), "Table1 Data");
        sheet.AddCell(new(5, 0), "Table2 Header");
        sheet.AddCell(new(5, 1), "Table2 Data");
