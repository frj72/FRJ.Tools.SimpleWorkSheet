...
public static class CellBordersExtensions
{
    ...
    public static IEnumerable<string> GetAllColors(this CellBorders cellBorders)
    {
        ...
        if (cellBorders.Left?.Color is not null)
        {
            colors.Add(cellBorders.Left.Color);
        }
        if (cellBorders.Right?.Color is not null)
        {
            colors.Add(cellBorders.Right.Color);
        }
        if (cellBorders.Top?.Color is not null)
        {
            colors.Add(cellBorders.Top.Color);
        }
        if (cellBorders.Bottom?.Color is not null)
        {
            colors.Add(cellBorders.Bottom.Color);
        }
