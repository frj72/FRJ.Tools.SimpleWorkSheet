...
public class LineChartMultipleSeriesWithColorsExample : IExample
{
    ...
    public void Run()
    {
        ...
        var lineChart = LineChart.Create()
            .WithTitle("Regional Sales (Custom Colors)")
            ...
            .AddSeries("North", northRange, Colors.Blue)
            .AddSeries("South", southRange, Colors.Green)
            .AddSeries("West", westRange, Colors.Red);
