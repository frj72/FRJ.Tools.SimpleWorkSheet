...
public class HyperlinksExample : IExample
{
    ...
    public void Run()
    {
        ...
        sheet.AddCell(new(0, 0), "Type");
        sheet.AddCell(new(1, 0), "Link");

        sheet.AddCell(new(0, 1), "Website");
