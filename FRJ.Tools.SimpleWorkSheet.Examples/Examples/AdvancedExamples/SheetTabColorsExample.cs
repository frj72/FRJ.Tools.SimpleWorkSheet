...
public class SheetTabColorsExample : IExample
{
    ...
    public void Run()
    {
        ...
        summarySheet.AddCell(new(0, 2), "Q1: $125,000");
        summarySheet.AddCell(new(0, 3), "Q2: $142,000");
        summarySheet.AddCell(new(0, 4), "Q3: $138,500");
        summarySheet.AddCell(new(0, 5), "Q4: $159,200");
        summarySheet.SetTabColor("4472C4");

        var q1Sheet = new WorkSheet("Q1 Sales");
        q1Sheet.AddCell(new(0, 0), "Q1 Sales Data", cell => cell
            .WithFont(font => font.Bold()));
        q1Sheet.AddCell(new(0, 1), "Product A");
        q1Sheet.AddCell(new(1, 1), 45000);
        q1Sheet.AddCell(new(0, 2), "Product B");
        q1Sheet.AddCell(new(1, 2), 80000);
        q1Sheet.SetTabColor("92D050");

        var q2Sheet = new WorkSheet("Q2 Sales");
        q2Sheet.AddCell(new(0, 0), "Q2 Sales Data", cell => cell
            .WithFont(font => font.Bold()));
        q2Sheet.AddCell(new(0, 1), "Product A");
        q2Sheet.AddCell(new(1, 1), 52000);
        q2Sheet.AddCell(new(0, 2), "Product B");
        q2Sheet.AddCell(new(1, 2), 90000);
        q2Sheet.SetTabColor("00B050");

        var q3Sheet = new WorkSheet("Q3 Sales");
        q3Sheet.AddCell(new(0, 0), "Q3 Sales Data", cell => cell
            .WithFont(font => font.Bold()));
        q3Sheet.AddCell(new(0, 1), "Product A");
        q3Sheet.AddCell(new(1, 1), 48500);
        q3Sheet.AddCell(new(0, 2), "Product B");
        q3Sheet.AddCell(new(1, 2), 90000);
        q3Sheet.SetTabColor("FFC000");

        var q4Sheet = new WorkSheet("Q4 Sales");
        q4Sheet.AddCell(new(0, 0), "Q4 Sales Data", cell => cell
            .WithFont(font => font.Bold()));
        q4Sheet.AddCell(new(0, 1), "Product A");
        q4Sheet.AddCell(new(1, 1), 59200);
        q4Sheet.AddCell(new(0, 2), "Product B");
        q4Sheet.AddCell(new(1, 2), 100000);
