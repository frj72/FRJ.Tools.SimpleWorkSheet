...
public class NamedRangesExample : IExample
{
    ...
    public void Run()
    {
        ...
        sheet.AddCell(new(1, 1), 1250.0, null);
        sheet.AddCell(new(2, 1), 1420.0, null);
        sheet.AddCell(new(3, 1), 1380.0, null);
        sheet.AddCell(new(4, 1), 1550.0, null);

        sheet.AddCell(new(0, 2), "Product B", null);
        sheet.AddCell(new(1, 2), 980.0, null);
        sheet.AddCell(new(2, 2), 1150.0, null);
        sheet.AddCell(new(3, 2), 1200.0, null);
        sheet.AddCell(new(4, 2), 1320.0, null);

        sheet.AddCell(new(0, 3), "Product C", null);
        sheet.AddCell(new(1, 3), 1820.0, null);
        sheet.AddCell(new(2, 3), 1950.0, null);
        sheet.AddCell(new(3, 3), 2100.0, null);
        sheet.AddCell(new(4, 3), 2250.0, null);

        sheet.AddCell(new(5, 1), new CellFormula("=SUM(B2:E2)"), null);
        sheet.AddCell(new(5, 2), new CellFormula("=SUM(B3:E3)"), null);
        sheet.AddCell(new(5, 3), new CellFormula("=SUM(B4:E4)"), null);
        ...
        sheet.AddCell(new(0, 7), "Total All Products:", null);
        sheet.AddCell(new(1, 7), new CellFormula("=SUM(TotalSales)"), null);

        sheet.AddCell(new(0, 8), "Average Per Product:", null);
        sheet.AddCell(new(1, 8), new CellFormula("=AVERAGE(TotalSales)"), null);

        sheet.AddCell(new(0, 9), "Max Quarter (All):", null);
        sheet.AddCell(new(1, 9), new CellFormula("=MAX(QuarterlySales)"), null);

        sheet.AddCell(new(0, 10), "Min Quarter (All):", null);
        sheet.AddCell(new(1, 10), new CellFormula("=MIN(QuarterlySales)"), null);
