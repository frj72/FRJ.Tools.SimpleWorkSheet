...
public static class Program
{
    public static void Main()
    {
        var examples = new List<IExample>
        {
            ...
            new LineChartWithoutCategoriesExample(),
            new LineChartMultipleSeriesWithoutCategoriesExample(),
            new BarChartWithoutCategoriesExample(),
            new AreaChartWithoutCategoriesExample(),
            new PieChartExample(),
            ...
            new ChartSeriesNamesImportAutoExample(),
            new ChartSeriesNamesImportCustomExample(),
            new ChartSeriesNamesImportCsvExample(),
            new ChartSeriesNamesImportGenericTableExample(),
