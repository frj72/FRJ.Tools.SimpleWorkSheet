...
workbook.SaveToFile("FRJ.Tools.SimpleWorkSheet.Examples/Output/32_FreezePanes_Test.xlsx");
Console.WriteLine("Generated 32_FreezePanes_Test.xlsx - Please test in Excel");
