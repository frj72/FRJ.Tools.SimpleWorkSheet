...
public class ExtremeSizesExample : IShowcase
{
    ...
    public void Run()
    {
        ...
        sheet.AddCell(new(0, 1), "Minimum column width (1.0)", null);
        sheet.AddCell(new(1, 1), "Tiny", null);
        sheet.SetColumnWidth(1, 1.0);
        
        sheet.AddCell(new(0, 3), "Maximum column width (255.0)", null);
        sheet.AddCell(new(2, 3), "This column is very wide - Excel maximum", null);
        sheet.SetColumnWidth(2, 255.0);
        
        sheet.AddCell(new(0, 5), "Minimum row height (1.0)", null);
        sheet.AddCell(new(1, 5), "Short", null);
        sheet.SetRowHeight(5, 1.0);
        
        sheet.AddCell(new(0, 7), "Maximum row height (409.0)", null);
        sheet.AddCell(new(1, 7), "Tall row", null);
        sheet.SetRowHeight(7, 409.0);
        
        sheet.AddCell(new(0, 9), "Normal size for comparison", null);
        sheet.AddCell(new(1, 9), "Default", null);
