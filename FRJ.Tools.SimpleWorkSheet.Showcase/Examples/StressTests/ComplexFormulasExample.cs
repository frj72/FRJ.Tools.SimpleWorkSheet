...
public class ComplexFormulasExample : IShowcase
{
    ...
    public void Run()
    {
        ...
        {
            sheet1.AddCell(new(0, row), (row + 1) * 10m);
            sheet2.AddCell(new(0, row), (row + 1) * 5m);
        }
        ...
        summary.AddCell(new(0, 1), "Sum from Sheet1");
        summary.AddCell(new(1, 1), new CellFormula("=SUM(Data1!A1:A100)"));
        
        summary.AddCell(new(0, 2), "Sum from Sheet2");
        summary.AddCell(new(1, 2), new CellFormula("=SUM(Data2!A1:A100)"));
        
        summary.AddCell(new(0, 3), "Total from both");
        summary.AddCell(new(1, 3), new CellFormula("=B2+B3"));
        
        summary.AddCell(new(0, 4), "Average Sheet1");
        summary.AddCell(new(1, 4), new CellFormula("=AVERAGE(Data1!A1:A100)"));
        
        summary.AddCell(new(0, 5), "Max from Sheet2");
        summary.AddCell(new(1, 5), new CellFormula("=MAX(Data2!A1:A100)"));
        
        summary.SetColumnWith(0, 20.0);
        summary.SetColumnWith(1, 15.0);
